...
ActiveRecord::Schema.define(version: 2023_07_25_014426) do
  ...
  create_table "test_case_labels", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "test_case_results", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "test_case_id"
    t.text "error_title"
  ...
  create_table "test_suites", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
